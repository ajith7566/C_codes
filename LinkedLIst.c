...
node* start = NULL;
void createList(int); // starts by creating a list.
void display_list(); // displays the contents in the list.
void insert_beg(); // inserts data in the beginning.
void insert_pos(int, int); //inserts data at any position.
void delete_beg(); //deletes node from the begining.
void delete_pos(int); // deletes npde from any position.
